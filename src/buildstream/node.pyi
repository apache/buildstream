...
class ProvenanceInformation:
    ...
    _line: int
    _col: int
    _toplevel: MappingNode | None
    _project: Project | None
    _is_synthetic: bool

    def __init__(self, nodeish: Node): ...
...
class MappingNode(Node, Generic[TNode]):
    ...
    def _find(self, target: Node) -> list[Node]: ...
    def clone(self) -> MappingNode[TNode]: ...
    def keys(self) -> Iterable[str]: ...
    def items(self) -> Iterable[Tuple[str, Any]]: ...
    def safe_del(self, key: str) -> None: ...
    def validate_keys(self, valid_keys: Iterable[str]): ...
    ...
    @overload
    def get_sequence(self, key: str, default: Optional[List[Any]]) -> SequenceNode: ...
    @overload
    ...
    @overload
    def get_node(self, key: str, allow_none: bool) -> Optional[Node]: ...
    @overload
    ...
    def _assert_fully_composited(self) -> None: ...
