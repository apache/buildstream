...
class Element(Plugin):
    ...
    *Since: 1.4*
    ...
    def _pull_pending(self):
        ...
        strong_cached = self._cached(_KeyStrength.STRONG)
    ...
    # _is_strong_cached_by_artifact():
    #
    # TODO: DOCSTRING
    #
    def _is_strong_cached_by_artifact(self):
        return self.__strict_artifact.cached()

    # _is_weak_cached_by_artifact()
    #
    # TODO: Doctring
    def _is_weak_cached_by_artifact(self):
